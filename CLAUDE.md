...
| 役割 | モデル | ファイル | 呼び出し条件 |
|---|---|---|---|
| **Reviewer（一次審査）** | `ollama/llama-3.3-70b-versatile`（Groq）or ローカル Ollama | `reviewer.py` / `scripts/review.py` | 毎回必ず呼ぶ |
...
- Current Reviewer model: `ollama/llama-3.3-70b-versatile` (Groq). Current Supervisor model: `claude-opus-4-5`.
